...
df1 = pd.read_csv("to12.csv")
df2 = pd.read_csv("PredictData.csv")
df1['PowerPredict'] = df2['Power Generated']
...
df.to_csv('WindPowerDay&Month.csv', index=False)
...
#for i in range(leng):
  #if df_stats['Wind Speed'][i] > 3 and df_stats['Power Generated'][i] != 0:
